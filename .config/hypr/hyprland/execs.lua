...
hl.on("hyprland.start", function()
    ...
    -- Cursors
    hl.exec_cmd("sh -c 'sleep 5 && gsettings set org.gnome.desktop.interface cursor-theme " .. vars.cursorTheme .. " && gsettings set org.gnome.desktop.interface cursor-size " .. vars.cursorSize .. " && hyprctl setcursor " .. vars.cursorTheme .. " " .. vars.cursorSize .. "' &")
    -- hl.exec_cmd("sleep 5 && hyprctl setcursor " .. vars.cursorTheme .. " " .. vars.cursorSize)
